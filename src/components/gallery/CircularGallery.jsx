    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          p.z = (sin(p.x * 4.0 + uTime) * 0.3 + cos(p.y * 2.0 + uTime) * 0.3) * (0.04 + uSpeed * 0.15);
...
class App {
  ...
  addEventListeners() {
    ...
    // Scope interaction events to the container so they don't
    // conflict with the page-level Lenis smooth scroll.
